...
export default {
  ...
  description: 'Shows top 10 weekly ranks on leaderboard.',
  /**
   *
   * @param {Client} client
  ...
  callback: async (client, interaction) => {
    ...
    card
      ...
      .setBackground(
        'C:\\Users\\manan\\OneDrive\\Desktop\\discordBot\\Images\\guillaume-le-louarn-uC21aXJ7yQs-unsplash.jpg'
      )
